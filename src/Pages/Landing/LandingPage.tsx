...
const ReviewSection: React.FC<ReviewSectionProps> = ({ children }) => {
				...
				<div className="main-body">
					<section className="hero flex-column">
						...
						<div className="heading align-center">
							...
							<p>
								Give your greatest asset the tools to connect,
								engage and communicate with your admins.
							</p>
						</div>
						...
						<div id="user-buttons">
							...
							<button className="learn-more no-bg-button">
					...
					<div className="descriptors flex-column">
						<Descriptor
							companionImagePath="src/assets/image 01.png"
							title="Drive Engagement with a Purpose"
							description="Lorem ipsum, dolor sit amet consectetur adipisicing elit. Necessitatibus cumque."
							list={{
								"Some sample text about sample topic. ▷":
									"/Misc/coming-soon.html",
								"Some other sample text about sample topic. ▷":
									"/Misc/coming-soon.html",
								"Some more sample text about sample topic. ▷":
									"/Misc/coming-soon.html",
							}}
						/>

						<Descriptor
							companionImagePath="src/assets/business.png"
							title="Drive Engagement with a Purpose"
					...
					<div className="reviews flex-column">
						<section className="heading">
							<h2>
								Trusted by the fastest growing startups and
								companies
							</h2>
							<p>
								Lorem ipsum, dolor sit amet consectetur
								adipisicing elit. Magnam eius eaque
								necessitatibus amet adipisci facere, dolore
								eveniet.
							</p>
						</section>
					...
					<div className="want-to-learn-more">
						<section className="heading">
							...
							<p>
								Lorem ipsum dolor sit amet consectetur
								adipisicing elit. Aliquam, maiores. Consectetur
								temporibus ipsum doloremque, odit, ratione,
								similique natus dolorum molestias blanditiis
								tenetur dolor.
							</p>
						</section>
			...
			<footer>
				...
				<div id="footer-links">
					<div>
						...
						<a href="index.html">
							<img
								src="/Images/generic-company-logo.png"
								alt="Company Logo"
								width="150"
								height="45"
							/>
					...
					<div id="links-container">
						...
						<div className="link-list">
							...
							<ul>
								...
								<li>
									<a href="/Misc/coming-soon.html">Legal</a>
								</li>
							</ul>
						</div>
					</div>
					...
					<div id="lang-copywrite">
						<div className="dropdown">
							...
							<ul
								...
								className="dropdown-content footer-bg scrollable-v"
							>
								<li>
